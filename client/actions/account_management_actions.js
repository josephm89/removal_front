...
export function getUsers() {
  return function(dispatch) {
    const url = "https://rocky-scrubland-37288.herokuapp.com/api/users";
    axios
...
export function updateCost(cost_obj) {
  return function(dispatch) {
    const url = "https://rocky-scrubland-37288.herokuapp.com/api/costs/update";
    axios
...
export function getCostsFromRails() {
  return function(dispatch) {
    const url = "https://rocky-scrubland-37288.herokuapp.com/api/costs/index";
    axios
      .get(url, { withCredentials: true })
      .then(response => {
        console.log("fulfilled", response.data);
...
export function updateAdmin(id, checked) {
  return function(dispatch) {
    const url = "https://rocky-scrubland-37288.herokuapp.com/users/" + id + ".json";
    const data = {
      user: {
        admin: checked
      }
